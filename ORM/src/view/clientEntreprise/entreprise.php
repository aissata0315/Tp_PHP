...
<article>
    ...
    <form name="form3"  method="post" enctype="multipart/form-data" class="Entreprise hidden ClientEntreprise">
        ...
        <input type="submit" name="addEntreprise" class="button_valider" value="Creer le compte">
    </form>
    <form  method = "post" id="form2" class="Particulier hidden clientParticulier">
        ...
        <input type="submit" name="addPhysique" class="button_valider" value="Creer le compte">
    </form>
