...
<div >
    <input type="text" name="numero" placeholder="Numero du compte"> <br>
    <input type="text" name="typeCompte" placeholder="Type de compte" required > <br>
    <input type="text" name="solde" placeholder="Solde initial" > <br>
  ...
  ?>
    <option value=" <?php echo sprintf( $personne->getId()); ?>"><?php echo sprintf("-%s\n", $personne->getPrenom()); ?> </option>
    <?php  }   ?>                      
    </select> <br>
