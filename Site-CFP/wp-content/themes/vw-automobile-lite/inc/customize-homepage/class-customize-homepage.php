 ...
 *
 * @package vw_automobile_lite
 */

if ( ! class_exists( 'VW_Automobile_Lite_Content_Creation' ) ) :

	class VW_Automobile_Lite_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * VW_Automobile_Lite_Content_Creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'VW_Automobile_Lite_Content_Creation' );
